            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 col-sm-6 col-xs-12">
                        <p class="phone-info">Call us: <a href="#">7680807448</a></p>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-12">
                ...
                <div class="col-md-9 col-sm-12 content-holder">
                    ...
                    <div id="menu-container">
                        ...
                        <div class="logo-holder logo-top-margin">
                            <a href="index.jsp" class="site-brand"><img src="images/32067.jpg" alt=""></a>
                        </div>
                        
                        
                        <div id="menu-1" class="homepage home-section text-center">
                            <div class="welcome-text">
                                <h2>Hello, Welcome to <strong>BANKING WORLD</strong></h2>
                                <p>We show our value by serving faithfully Thank you</p>
                                ...
                                <div class="col-md-8 col-sm-8">
                                    <div class="box-content profile">
                                        ...
                                        <div class="profile-content">
                                            <h5 class="profile-name">CH BALA GOWTHAM</h5>
                                            <span class="profile-role">Web page developer</span>
                                            <p>Hello my dear users you can get in touch with me through<a rel="nofollow" href="https://www.linkedin.com/in/bala-gowtham/"> linkedin </a> 
											</p>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        <p>
                        	Copyright &copy; 2022 BALA GOWTHAM
