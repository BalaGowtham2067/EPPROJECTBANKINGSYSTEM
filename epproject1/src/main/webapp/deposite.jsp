...
<div id="header">
	<IMG SRC="images/logoscot.png"></IMG>
	<h1>Hello Gowtham<span class="style1"></span></h1>
    <h2 style="font-family:verdana;">Welcome to your account</h1>
</div>
...
.active {
  background-color: #04AA6D;
    ...
    <ul>
    <li><a href="registration.jsp">NEW ACCOUNT</a></li>
    ...
    <td width="1200" valign="top">
		...
		<tr>
			...
			out.print(request.getAttribute("balance"));
			 ...
			 %></div>
				<form name=F1 onSubmit="return dil(this)" action="test.jsp" >
